...
const Bag = () => {
  ...
  const onRemove = (item) => {
    ...
    if (exist.qty === 1) {
      dispatch({
        type: "cartitem",
        payload: state.cartitem.filter((x) => x.id !== item.id),
      });
    } else {
      dispatch({
        type: "cartitem",
                          ...
                          <div className="itemContainer-base-details">
                            <div>
                              ...
                              <a
                                ...
                                href="/Shirts/Roadster/Roadster-Men-Maroon--Navy-Blue-Checked-Pure-Cotton-Casual-Sustainable-Shirt/9951411/buy?mini=true&amp;skuId=34612818&amp;sellerPartnerId=4118"
                              >
                                {item.desc}
                              </a>
                            </div>
                            ...
                            <div className="itemContainer-base-sizeAndQtyContainer">
                              <div className="itemContainer-base-sizeAndQty">
                                <div className="itemComponents-base-size">
                                  <span className="">Size: {item.size[0]}</span>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="6"
                                    height="3"
                                ...
                                <span className="itemComponents-base-strikedAmount">
                                  <span className="itemComponents-base-price itemComponents-base-strike itemContainer-base-strikedAmount">
                                    <svg
                                      ...
                                      height="10"
                                      viewBox="0 0 9 10"
                                      className="itemComponents-base-rupeeIcon "
                                    >
                                      <g fill-rule="nonzero">
