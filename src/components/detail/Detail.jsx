...
const Detail = ({ data }) => {
  ...
  const onAdd = (item) => {
    ...
    const AddWishList = () => {
      ...
      console.log();
      console.log("====================================");
      const exist = state.wishlist.find((x) => x.id === id);
      if (!exist) {
        dispatch({ type: "wishlist", payload: [...state.wishlist, data] });
      }
    };
    return (
      <>
                ...
                >
                  ...
                  "
                    ...
                    style={{
                      width: "100%",
                      textAlign: "center",
                      backgroundColor: state.wishlist.find((x) => x.id === id)
                        ? "#FF3E6C"
                        : "white",
                    }}
                  >
                    ...
                    <div>
                      ...
                      <ul className="pdp-offers-offerDesc">
                        ...
                        <li>
                          <div className="pdp-offers-bullet"></div>
                          <div className="pdp-offers-labelMarkup">
                            <span className="pdp-offers-boldText">
                              MYNTRA400
                            </span>
                          </div>
                        </li>
